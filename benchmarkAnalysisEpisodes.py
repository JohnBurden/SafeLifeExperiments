...
for metric in ["Lengths", "Exploration", "Rewards"]:
	...
	labels = ["DQN 5M", "DQN 10M", "DQN 30M", "DQN 60M", "PPO 5M", "PPO 10M", "PPO 30M", "PPO 60M", "Uniform Random Actions"]
	for ind, experiment in enumerate(["DQNAppendStillAll13Levels5M", "DQNAppendStillAll13Smaller", "DQNAppendStillAll13Levels30M", "DQNAppendStillAll13Levels60M", "PPOAppendStillAll13Levels5M", "PPOAppendStillAll13Levels60M", "PPOAppendStillAll13Levels30M",  "PPOAppendStillAll13Levels60M","UAAppendStillAll13Levels"]):
		print()
		print(experiment)
